$(document).ready(function () {
    ...
    function isValid(line, column, number){
        if(isRowValid(line,number) === true && isColumnValid(column,number) === true && isBlockValid(line,column,number) === true){
            return `GG ta tous niquer`
        }else{
            return `RIP`
        }
    }
    ...
    $(".generate").click(function () {
        displaySudoku();
        console.log(isRowValid(0,4))
        console.log(isColumnValid(0,4))
        console.log(isBlockValid(0,0,4))
